...
short int sensor_left = 0;
short int sensor_right = 0;
short int yellow_left = 0;
short int yellow_right = 0;

String color = "";
String colorToReturn = "blue";
String ipAddress;
...
void setup()
{
  ...
  Timer1.attachInterrupt(ultrasonic_read);
  display_intro();
