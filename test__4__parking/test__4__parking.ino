...
void loop()
{
  if(color == "red" || color == "green" || color == "blue")
  {
    LeaveHome();
    colorToReturn = color;
    while(color != "yellow"){/*display_status(color);*/ColorDetect();executeColor(color);Direction();FoundYellow();}
  }
  else
  {
...
void display_WiFi_connect()
{
  ...
  do {          //xpos,ypos,width,heigh,bitmap
    u8g2.drawXBMP(39,0,50,50,epd_bitmap_allArray[counter]);
